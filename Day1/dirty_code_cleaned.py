...
def get_cosine(vec1, vec2):
    """
    Take two vectors, calculates similarity between them, and return the said similarity.
...
def text_to_vector(text):
    """Convert the text into a collections Counter object."""
    WORD = re.compile(r'\w+')
...
class Query(object):
    ...
    def code_to_synonym(self, disease_code):
        """Extract the synonyms given a certain disease code."""
